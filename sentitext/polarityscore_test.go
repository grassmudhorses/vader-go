...
func TestPolarityScore(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: Sentiment{
				Negative: 0.20627878263582639,
				Neutral:  0.74417574868732,
				Positive: 0.04954546867685369,
				Compound: -0.9973376627379169,
			},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := PolarityScore(tt.text); !reflect.DeepEqual(got, tt.want) {
