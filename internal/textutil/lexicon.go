...
var Boosters map[string]float64 = map[string]float64{
	...
	`completely`:    BoosterIncrease,
	`considerably`:  BoosterIncrease,
	`decidedly`:     BoosterIncrease,
	`deeply`:        BoosterIncrease,
	`effing`:        BoosterIncrease,
	`enormously`:    BoosterIncrease,
	`entirely`:      BoosterIncrease,
	`especially`:    BoosterIncrease,
	`exceptionally`: BoosterIncrease,
	`extremely`:     BoosterIncrease,
	`fabulously`:    BoosterIncrease,
	`flipping`:      BoosterIncrease,
	`flippin`:       BoosterIncrease,
	`fricking`:      BoosterIncrease,
	`frickin`:       BoosterIncrease,
	`frigging`:      BoosterIncrease,
	`friggin`:       BoosterIncrease,
	`fully`:         BoosterIncrease,
	`fucking`:       BoosterIncrease,
	`greatly`:       BoosterIncrease,
	`hella`:         BoosterIncrease,
	`highly`:        BoosterIncrease,
	`hugely`:        BoosterIncrease,
	`incredibly`:    BoosterIncrease,
	`intensely`:     BoosterIncrease,
	`majorly`:       BoosterIncrease,
	`more`:          BoosterIncrease,
	`most`:          BoosterIncrease,
	`particularly`:  BoosterIncrease,
	`purely`:        BoosterIncrease,
	`quite`:         BoosterIncrease,
	`really`:        BoosterIncrease,
	`remarkably`:    BoosterIncrease,
	`so`:            BoosterIncrease,
	`substantially`: BoosterIncrease,
	`thoroughly`:    BoosterIncrease,
	`totally`:       BoosterIncrease,
	`tremendously`:  BoosterIncrease,
	`uber`:          BoosterIncrease,
	`unbelievably`:  BoosterIncrease,
	`unusually`:     BoosterIncrease,
	`utterly`:       BoosterIncrease,
	`very`:          BoosterIncrease,
	`almost`:        BoosterDecrease,
	`barely`:        BoosterDecrease,
	`hardly`:        BoosterDecrease,
	`just enough`:   BoosterDecrease,
	`kind of`:       BoosterDecrease,
	`kinda`:         BoosterDecrease,
	`kindof`:        BoosterDecrease,
	`kind-of`:       BoosterDecrease,
	`less`:          BoosterDecrease,
	`little`:        BoosterDecrease,
	`marginally`:    BoosterDecrease,
	`occasionally`:  BoosterDecrease,
	`partly`:        BoosterDecrease,
	`scarcely`:      BoosterDecrease,
	`slightly`:      BoosterDecrease,
	`somewhat`:      BoosterDecrease,
	`sort of`:       BoosterDecrease,
	`sorta`:         BoosterDecrease,
	`sortof`:        BoosterDecrease,
	`sort-of`:       BoosterDecrease,
}
